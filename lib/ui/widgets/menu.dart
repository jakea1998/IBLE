                  ...
                  child: SafeArea(
                      ...
                      child: Column(
                        children: [
                          ...
                          DrawerListItem(
                            selected: /* drawerController.selectedId == 1 */ false,
                            title: 'Memory Verse',
                            onTap: () {
                        ...
                        .select(1); */
                          ...
                          DrawerListItem(
                            selected: /* drawerController.selectedId == 2 */ false,
                            title: 'Favorite',
                            onTap: () {
                              /* Provider.of<IbDrawerController>(context, listen: false)
                        .select(2); */
                                ...
                                builder: (context, state) {
                                  return ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      if ((state.categories?.length ?? -1) > 0)
...
/* 
  ...
  buildListTitle(BuildContext context, int index,Category category) {
    final expandedCategory = -1;
   
    final hasChildren = 0 < (category.children?.length ?? 0);
    ...
    return Column(
      children: [
        DrawerListItem(
          ...
          selected: /* drawerController.selectedId == category.id, */ false,
            ...
            child: ListView.builder(
                ...
                itemBuilder: (context, position) {
                  ...
                  return Column(
                    children: [
                      DrawerListItem(
                        selected: /* drawerController.selectedId ==
                                        subCategory.id */
                            false,
